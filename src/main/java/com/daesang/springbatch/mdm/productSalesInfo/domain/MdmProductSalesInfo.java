...
/**
 * fileName         : MdmProductSalesInfo
 * author           : 권용성사원
 * date             : 2023-01-17
 * description      : 제품정보 - 제품 판매조직 기준 정보 ENTITY
 * =======================================================
 * DATE                AUTHOR             NOTE
 * -------------------------------------------------------
...
@Getter
@NoArgsConstructor
@Table(name="VW_CRM_MATERIAL_SODC",schema = "IFUSER")
@IdClass(MdmProductSalesInfoId.class)
public class MdmProductSalesInfo {
    // 자재코드
    @Id
    @Column(name = "MASTID")
