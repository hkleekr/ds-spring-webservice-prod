...
/**
 * fileName         : MdmProductMasterJobWriter
 * author           : inayoon
 * date             : 2022-10-21
...
public class MdmProductMasterJobWriter implements ItemWriter<MdmProductMasterDto> {
    ...
    @Override
    public void write(List<? extends MdmProductMasterDto> items) throws Exception {
        ...
        webClientService.getGatewayResponse(jsonObject, REQUEST_HOST, UrlEnum.MDM_02);
    }
