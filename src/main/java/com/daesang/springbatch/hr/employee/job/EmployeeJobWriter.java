...
/**
 * fileName         : EmployeeJobWriter
 * author           : 권용성사원
 * date             : 2022-10-26
 * descrition       : 통합인사 임직원 배치 아이템 Writer
 * =======================================================
 * DATE                AUTHOR             NOTE
 * -------------------------------------------------------
...
public class EmployeeJobWriter implements ItemWriter<EmployeeDto> {
    ...
    public void write(List<? extends EmployeeDto> items) throws Exception {
        ...
        webClientService.getGatewayResponse(jsonObject, REQUEST_HOST, UrlEnum.HR_59);
    }
