...
/**
 * fileName         : SapDomesticTransportJobWriter
 * author           : inayoon
 * date             : 2022-11-17
...
public class SapDomesticTransportJobWriter implements ItemWriter<SapDomesticTransportDto> {
    ...
    @Override
    public void write(List<? extends SapDomesticTransportDto> items) throws Exception {
        ...
        webClientService.getGatewayResponse(jsonObject, REQUEST_HOST, UrlEnum.SAP_118);
    }
