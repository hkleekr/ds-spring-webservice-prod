...
/**
 * fileName         : SapExportOrderJobWriter
 * author           : inayoon
 * date             : 2022-11-08
...
public class SapExportOrderJobWriter implements ItemWriter<SapExportOrderDto> {
    ...
    @Override
    public void write(List<? extends SapExportOrderDto> items) throws Exception {
        ...
        webClientService.getGatewayResponse(jsonObject, REQUEST_HOST, UrlEnum.SAP_85);
    }
