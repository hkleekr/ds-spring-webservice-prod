...
/**
 * fileName         : SapExportDeliveryJobWriter
 * author           : inayoon
 * date             : 2022-11-09
...
public class SapExportDeliveryJobWriter implements ItemWriter<SapExportDeliveryDto> {
    ...
    @Override
    public void write(List<? extends SapExportDeliveryDto> items) throws Exception {
        ...
        webClientService.getGatewayResponse(jsonObject, REQUEST_HOST, UrlEnum.SAP_86);
    }
