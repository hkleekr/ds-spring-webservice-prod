...
/**
 * fileName			: SampleJobWriter
 * author			: 최종민차장
 * date				: 2022-11-09
 * descrition       : 무상 주문 정보 batch item writer
 * =======================================================
 * DATE					AUTHOR					NOTE
 * -------------------------------------------------------
...
public class SampleJobWriter implements ItemWriter<SampleDto> {
    ...
    public void write(List<? extends SampleDto> items) throws Exception {
        ...
        webClientService.getGatewayResponse(jsonObject, REQUEST_HOST, UrlEnum.SAP_115);
    }
}
